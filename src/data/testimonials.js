export const TESTIMONIALS = [
  {
    id: 1, name: 'MRS.AMRUTHA',
    text: 'Loved the session Bindu. Your soft voice and calming approach created a peaceful learning space. The metallic color choices were perfectly balanced, and your clear explanation of tools and steps made the class enjoyable and easy to follow. Thank you for the wonderful session ',
  },
  {
    id: 2, name: 'MRS.RUCHI',
